...
:root {
    ...
    --attendance-gold-soft:
        rgba(200, 155, 60, 0.12);

    --attendance-gold-line:
    ...
    --attendance-blue-soft:
        rgba(77, 143, 232, 0.11);
...
[data-theme="dark"] {
    ...
    --attendance-gold-soft:
        rgba(213, 166, 63, 0.10);

    --attendance-gold-line:
        rgba(213, 166, 63, 0.28);

    --attendance-blue: #62a0f3;

    --attendance-blue-soft:
        rgba(98, 160, 243, 0.10);
...
.kpi-card {
    ...
    border:
        1px solid var(--attendance-border);

    border-radius: var(--attendance-radius);

    box-shadow:
        var(--attendance-shadow-soft);
...
.panel-head h3 i {
    ...
    border:
        1px solid var(--attendance-gold-line);
...
.members-table tbody td {
    ...
    color:
        var(--attendance-text) !important;

    border-bottom:
        1px solid var(--attendance-border-soft);
...
.members-table tbody td:nth-child(2) {
    ...
    color:
        var(--attendance-text-2) !important;
}
...
.source-chip.app {
    ...
    background:
        var(--attendance-blue-soft);

    border:
        1px solid rgba(77, 143, 232, 0.22);
}
...
.members-table .empty-row td {
    ...
    color:
        var(--attendance-muted) !important;
...
.pagination-wrap nav > div > div:last-child span[aria-disabled="true"] {
    ...
    background:
        var(--attendance-surface-3) !important;

    border-color:
        var(--attendance-border) !important;
...
<div class="attendance-wrapper">
    ...
    <div class="panel">
        ...
        <div class="filter-bar">
            ...
            <form
                action="{{ route('admin.attendance.players.index') }}"
                method="GET"
                class="filter-form"
            >
                ...
                <div>
                    ...
                    <a
                        href="{{ route('admin.attendance.players.index') }}"
