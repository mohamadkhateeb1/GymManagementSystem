       ...
       ========================================================= */
        ...
        .attendance-container .filter-grid {
            ...
            grid-template-columns:
                minmax(180px, 1.2fr) minmax(160px, 1fr) minmax(150px, 1fr) minmax(150px, 1fr) minmax(180px, auto);
    ...
    <div class="dashboard-wrapper attendance-container">
        ...
        <div class="page-header">
            <div>
                ...
                <span style="color: var(--text-soft, #4b5563); font-size: 13px; font-weight: 600;">تتبع ومراقبة الأداء
                    الزمني وساعات العمل الفعلية للموظفين
                    والمدربين</span>
            </div>
        </div>
                ...
                <table class="luxury-table">
                    ...
                    <tbody>
                        ...
                        @empty
                            <tr>
                                <td colspan="7"
                                    style="text-align: center; padding: 50px; color: var(--text-soft, #4b5563);">
