...
@section('styles')
    ...
    <style>
        ...
        .employee-avatar {
            ...
            color: #fff;
            font-size: 23px;
            box-shadow: 0 7px 18px rgba(184, 146, 62, .16);
        }
        ...
        .employee-edit-button {
            ...
            box-shadow: 0 5px 14px rgba(184, 146, 62, .14);
            transition: .2s ease;
        }

        .employee-edit-button:hover {
            transform: translateY(-1px);
            box-shadow: 0 8px 18px rgba(184, 146, 62, .20);
            color: #fff;
        }
    ...
    <div class="employee-page">
        ...
        <div class="employee-profile-card">
            ...
            <div class="employee-card-footer">
                ...
                <a href="{{ route('employees.edit', $employee->id) }}" class="employee-edit-button">
