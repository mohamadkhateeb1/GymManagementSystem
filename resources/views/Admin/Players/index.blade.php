...
@section('styles')
    <style>
        ...
        .btn-add {
            ...
            box-shadow: 0 5px 13px rgba(181, 128, 31, .18);
        }

        .btn-add:hover {
            transform: translateY(-1px);
            box-shadow: 0 8px 17px rgba(181, 128, 31, .25);
        }

        .btn-danger {
            color: var(--danger);
            background: var(--danger-bg);
            border-color: rgba(196, 93, 93, .22);
        }
        ...
        .field-input:focus {
            ...
            box-shadow: 0 0 0 3px rgba(181, 128, 31, .10);
        }
        ...
        .btn-freeze {
            color: var(--warning, var(--gold-dark));
    ...
    <div class="filter-bar">
        <form action="{{ route('players.index') }}" method="GET" class="row g-3 align-items-end">
            <div class="col-12 col-md-4">
                ...
                <input type="text" name="search" class="field-input" value="{{ request('search') }}"
            ...
            <div class="col-6 col-md-3">
                ...
                <select name="subscription_status" class="field-input">
                    ...
                    <option value="expired" {{ request('subscription_status') == 'expired' ? 'selected' : '' }}>منتهي/مجمد
                    </option>
                    <option value="none" {{ request('subscription_status') == 'none' ? 'selected' : '' }}>بلا اشتراك
                    </option>
                </select>
            </div>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="action-group">
                                ...
                                @endcan
                                @can('player.toggle_subscription')
                                @if ($player->subscription)
