...
.training-bank-panel {
    ...
    animation:
        trainingPanelIn .5s cubic-bezier(.2, .7, .2, 1)
        both;
}
...
<div class="training-bank-page">
                        ...
                        <tr>
                            ...
                            <td style="text-align: center;">
                                ...
                                <div class="plan-actions">
                                    ...
                                    <a
                                        href="{{ route(
                                            'employee.training.exercises.index',
                                            $plan->id
                                        ) }}"
                                    ...
                                    <form
                                        action="{{ route(
                                            'employee.training.bank.distribute',
                                            $plan->id
                                        ) }}"
                                        method="POST"
                                        onsubmit="
                                    ...
                                    <form
                                        action="{{ route(
                                            'employee.training.bank.destroy',
                                            $plan->id
                                        ) }}"
                                        method="POST"
                                        onsubmit="
    ...
    <div
        ...
        role="dialog"
        aria-modal="true"
        aria-labelledby="addPlanModalTitle">
        ...
        <div class="modal-content">
            ...
            <form
                action="{{ route('employee.training.bank.store') }}"
                method="POST">
