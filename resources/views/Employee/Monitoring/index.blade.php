...
@section('styles')
    ...
    <style>
        /* =========================================================
       ELITE CLUB — EMPLOYEE MONITORING
       ...
       ========================================================== */
        ...
        .rating-stars-gold {
            ...
            filter:
                drop-shadow(0 0 4px rgba(201, 169, 97, .20));
        }
       ...
       ========================================================= */
        ...
        .btn-apply-luxury:hover {
            ...
            box-shadow:
                0 10px 23px rgba(184, 146, 62, .22);
